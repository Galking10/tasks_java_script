...
// const taggleUserState = (allUsers, userName)=>{
//   return new Promise((resolve, reject) => {
...
//  * Должно работать так
//  */
// taggleUserState(users, 'Mango').then((users)=> console.log(users));
// taggleUserState(users, 'Lux').then((users)=> console.log(users));
...
//   .then((data)=> logSuccess(data.id, data.delay))
//   .catch(logError);
