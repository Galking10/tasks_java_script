...
// Объяви две переменные хранящие название и цену товара: names и price
...
let names = 'Генератор защитного поля'
let price = 1000
console.log(`Выбран "${names}", цена за штуку ${price} кредитов`)
price = 2000
console.log(`Выбран "${names}", цена за штуку ${price} кредитов`)

function sign(names, price) {
    return `Выбран "${names}", цена за штуку ${price} кредитов`
}

console.log(sign(names, price))
...
function Availability(total, ordered) {
    if (total < ordered) {
...
console.log(Availability(total, ordered))
...
function count(){
    ...
    if (credits < totalPrice ) {
        ...
        return `Вы купили ${numberOfDroid} дроидов, на счету осталось ${restOfCredits} кредитов.`
    }
...
function checkDelivery() {
    let yourCountry = prompt('Введите страну').toLowerCase()
